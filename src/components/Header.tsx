...
const components: { title: string; href: string; description: string }[] = [
  {
    ...
    href: "/catalog",
    description:
      "Descubre los cursos disponibles en este semestre en la universidad.",
  },
  {
    title: "Sobre las Áreas de Formación General",
    href: "/docs/primitives/hover-card",
    description:
      "Conoce las áreas de formación general y cómo se relacionan con los cursos.",
  },
];
                      ...
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <p className="text-background text-sm leading-tight">
                            La comunidad estudiantil de innovación y desarrollo
                            de software de la UC.
                          </p>
                        </a>
                      </NavigationMenuLink>
                    </li>
